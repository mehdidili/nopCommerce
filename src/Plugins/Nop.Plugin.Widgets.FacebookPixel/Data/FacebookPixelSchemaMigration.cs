...
{
    [NopMigration("2020/03/25 12:00:00", "Widgets.FacebookPixel base schema", MigrationTarget = MigrationTarget.Schema, MigrationProcessType = MigrationProcessType.Install)]
